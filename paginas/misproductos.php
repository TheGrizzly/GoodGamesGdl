		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<?php
					...
					$sql = "SELECT p.nombre as Producto, u.nombre as Vendedor, p.precio as Precio, v.fecha as Fecha from producto as p, usuario as u, venta as v where u.id_usuario=v.id_vendedor and p.id_usuario=v.id_comprador and v.id_vendedor=".$_SESSION["id_u"];
