		...
		<div class='row'>
			...
			<div class='col-sm-6 text-center'>
				<h3>Nuevo producto</h3>
					<?php echo"<form action='editarproductos.php?idproducto=".$producto."' id='producto' enctype='multipart/form-data' method='POST'>"; ?>
						<div class='form-group'>
						    <label for='text'>Nombre del producto:</label>
						   <?php echo"<textarea class='form-control' name='nombre' id='nombre' style='height:2.5em' maxlength='100'>".$row['nombre']."</textarea>"; ?>
						...
						<div class="form-group">
						    ...
						    <?php echo"<input type='text' class='form-control' id='price' name='price' maxlength='3' placeholder='Ej: 1000.00' value=".$row['precio'].">"; ?>
						</div>
						<div class="form-group">
				...
				<?php echo"<img src='../img/productos/".$row['id_producto'].".jpg' id='imgpro' width='50%' alt='Image'>"; ?>
